...
# Mengubah format data ke bentuk yang lebih standard (contohnya, kolom date, maupun datetime 
# yang biasanya memiliki nilai yang tidak standard maupun nomor HP yang biasanya memiliki nilai 
# yang tidak sesuai format standardnya), dan lainnya. 
...
# Ada permintaan datang dari tim logistik bahwa mereka membutuhkan kode pos dari peserta 
# agar pengiriman piala lebih mudah dan cepat sampai. Maka dari itu buatlah kolom baru bernama postal_code 
# yang memuat informasi mengenai kode pos yang diambil dari alamat peserta (kolom address).
...
# Untuk menyediakan informasi tersebut, buatlah kolom baru bernama city yang didapat dari kolom address. 
...
# Salah satu parameter untuk mengetahui proyek apa saja yang pernah dikerjakan oleh peserta
# yaitu dari git repository mereka.

# Pada kasus ini kita menggunakan profil github sebagai parameternya. Tugas Anda yaitu membuat kolom baru 
# bernama github_profile yang merupakan link profil github dari peserta.
